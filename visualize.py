...
def print_usage_and_exit():
    print(
        "Usage: ml-test.py [nuscenes|kitti|semantickitti|paris|toronto|semantic3d|s3dis|custom] path/to/dataset"
    )
    exit(0)
...
def main():
    ...
    if dataset is None:  # custom
        ...
        v.visualize_dataset(dataset, "training", indices = range(50))
